...
class DeviceState extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(13)
  $core.List<NodeRemoteHardwarePin> get nodeRemoteHardwarePins => $_getList(8);
...
class OEMStore extends $pb.GeneratedMessage {
  factory OEMStore({
    ...
    $7.LocalConfig? oemLocalConfig,
    $7.LocalModuleConfig? oemLocalModuleConfig,
  }) {
    final $result = create();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$7.LocalConfig>(7, _omitFieldNames ? '' : 'oemLocalConfig',
        subBuilder: $7.LocalConfig.create)
    ..aOM<$7.LocalModuleConfig>(
        8, _omitFieldNames ? '' : 'oemLocalModuleConfig',
        subBuilder: $7.LocalModuleConfig.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(7)
  $7.LocalConfig get oemLocalConfig => $_getN(6);

  @$pb.TagNumber(7)
  set oemLocalConfig($7.LocalConfig v) {
    setField(7, v);
  }
  ...
  @$pb.TagNumber(7)
  $7.LocalConfig ensureOemLocalConfig() => $_ensure(6);

  ///
  ///  A Preset LocalModuleConfig to apply during factory reset
  @$pb.TagNumber(8)
  $7.LocalModuleConfig get oemLocalModuleConfig => $_getN(7);

  @$pb.TagNumber(8)
  set oemLocalModuleConfig($7.LocalModuleConfig v) {
    setField(8, v);
  }
  ...
  @$pb.TagNumber(8)
  $7.LocalModuleConfig ensureOemLocalModuleConfig() => $_ensure(7);
}
...
class NodeRemoteHardwarePin extends $pb.GeneratedMessage {
  ...
  factory NodeRemoteHardwarePin.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);

  factory NodeRemoteHardwarePin.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$1.RemoteHardwarePin>(2, _omitFieldNames ? '' : 'pin',
        subBuilder: $1.RemoteHardwarePin.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(2)
  $1.RemoteHardwarePin get pin => $_getN(1);

  @$pb.TagNumber(2)
  set pin($1.RemoteHardwarePin v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(2)
  $1.RemoteHardwarePin ensurePin() => $_ensure(1);
}
