...
const DeviceState$json = {
  ...
  '2': [
    ...
    {'1': 'no_save', '3': 9, '4': 1, '5': 8, '10': 'noSave'},
...
final $typed_data.Uint8List deviceStateDescriptor = $convert.base64Decode(
    ...
    'YXN0aWMuTWVzaFBhY2tldFINcnhUZXh0TWVzc2FnZRIXCgdub19zYXZlGAkgASgIUgZub1Nhdm'
    'USIgoNZGlkX2dwc19yZXNldBgLIAEoCFILZGlkR3BzUmVzZXQSNwoLcnhfd2F5cG9pbnQYDCAB'
    'KAsyFi5tZXNodGFzdGljLk1lc2hQYWNrZXRSCnJ4V2F5cG9pbnQSXAoZbm9kZV9yZW1vdGVfaG'
    'FyZHdhcmVfcGlucxgNIAMoCzIhLm1lc2h0YXN0aWMuTm9kZVJlbW90ZUhhcmR3YXJlUGluUhZu'
    'b2RlUmVtb3RlSGFyZHdhcmVQaW5zEjoKDG5vZGVfZGJfbGl0ZRgOIAMoCzIYLm1lc2h0YXN0aW'
    'MuTm9kZUluZm9MaXRlUgpub2RlRGJMaXRl');
...
final $typed_data.Uint8List nodeInfoLiteDescriptor = $convert.base64Decode(
    ...
    'Y3NSDWRldmljZU1ldHJpY3MSGAoHY2hhbm5lbBgHIAEoDVIHY2hhbm5lbA==');
