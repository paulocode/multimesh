...
class LocalConfig extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set device($0.Config_DeviceConfig v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(2)
  set position($0.Config_PositionConfig v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(3)
  set power($0.Config_PowerConfig v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(4)
  set network($0.Config_NetworkConfig v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(5)
  set display($0.Config_DisplayConfig v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(6)
  set lora($0.Config_LoRaConfig v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(7)
  set bluetooth($0.Config_BluetoothConfig v) {
    setField(7, v);
  }
...
class LocalModuleConfig extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  set mqtt($1.ModuleConfig_MQTTConfig v) {
    setField(1, v);
  }
  ...
  @$pb.TagNumber(2)
  set serial($1.ModuleConfig_SerialConfig v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(3)
  set externalNotification($1.ModuleConfig_ExternalNotificationConfig v) {
    setField(3, v);
  }
  ...
  @$pb.TagNumber(4)
  set storeForward($1.ModuleConfig_StoreForwardConfig v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(5)
  set rangeTest($1.ModuleConfig_RangeTestConfig v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(6)
  set telemetry($1.ModuleConfig_TelemetryConfig v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(7)
  set cannedMessage($1.ModuleConfig_CannedMessageConfig v) {
    setField(7, v);
  }
  ...
  @$pb.TagNumber(9)
  set audio($1.ModuleConfig_AudioConfig v) {
    setField(9, v);
  }
  ...
  @$pb.TagNumber(10)
  set remoteHardware($1.ModuleConfig_RemoteHardwareConfig v) {
    setField(10, v);
  }
  ...
  @$pb.TagNumber(11)
  set neighborInfo($1.ModuleConfig_NeighborInfoConfig v) {
    setField(11, v);
  }
  ...
  @$pb.TagNumber(12)
  set ambientLighting($1.ModuleConfig_AmbientLightingConfig v) {
    setField(12, v);
  }
  ...
  @$pb.TagNumber(13)
  set detectionSensor($1.ModuleConfig_DetectionSensorConfig v) {
    setField(13, v);
  }
  ...
  @$pb.TagNumber(14)
  set paxcounter($1.ModuleConfig_PaxcounterConfig v) {
    setField(14, v);
  }
