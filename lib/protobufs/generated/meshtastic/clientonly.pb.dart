...
class DeviceProfile extends $pb.GeneratedMessage {
  factory DeviceProfile({
    ...
    $7.LocalConfig? config,
    $7.LocalModuleConfig? moduleConfig,
  }) {
    final $result = create();
    if (longName != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$7.LocalConfig>(4, _omitFieldNames ? '' : 'config',
        subBuilder: $7.LocalConfig.create)
    ..aOM<$7.LocalModuleConfig>(5, _omitFieldNames ? '' : 'moduleConfig',
  ...
  @$pb.TagNumber(4)
  $7.LocalConfig get config => $_getN(3);

  @$pb.TagNumber(4)
  set config($7.LocalConfig v) {
    setField(4, v);
  }
  ...
  @$pb.TagNumber(4)
  $7.LocalConfig ensureConfig() => $_ensure(3);

  ///
  ///  The ModuleConfig of the node
  @$pb.TagNumber(5)
  $7.LocalModuleConfig get moduleConfig => $_getN(4);

  @$pb.TagNumber(5)
  set moduleConfig($7.LocalModuleConfig v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(5)
  $7.LocalModuleConfig ensureModuleConfig() => $_ensure(4);
}
