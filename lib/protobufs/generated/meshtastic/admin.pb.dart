...
class AdminMessage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$1.Config>(6, _omitFieldNames ? '' : 'getConfigResponse',
    ...
    ..aOM<$2.ModuleConfig>(8, _omitFieldNames ? '' : 'getModuleConfigResponse',
        subBuilder: $2.ModuleConfig.create)
    ...
    ..aOM<$7.DeviceConnectionStatus>(
        17, _omitFieldNames ? '' : 'getDeviceConnectionStatusResponse',
        subBuilder: $7.DeviceConnectionStatus.create)
    ...
    ..aOM<$3.Channel>(33, _omitFieldNames ? '' : 'setChannel',
        subBuilder: $3.Channel.create)
    ..aOM<$1.Config>(34, _omitFieldNames ? '' : 'setConfig',
        subBuilder: $1.Config.create)
    ..aOM<$2.ModuleConfig>(35, _omitFieldNames ? '' : 'setModuleConfig',
        subBuilder: $2.ModuleConfig.create)
    ...
    ..aOM<$6.Position>(41, _omitFieldNames ? '' : 'setFixedPosition',
        subBuilder: $6.Position.create)
  ...
  @$pb.TagNumber(6)
  set getConfigResponse($1.Config v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(8)
  set getModuleConfigResponse($2.ModuleConfig v) {
    setField(8, v);
  }
  ...
  @$pb.TagNumber(17)
  set getDeviceConnectionStatusResponse($7.DeviceConnectionStatus v) {
    setField(17, v);
  }
  ...
  @$pb.TagNumber(17)
  $7.DeviceConnectionStatus ensureGetDeviceConnectionStatusResponse() =>
      $_ensure(15);
  ...
  @$pb.TagNumber(22)
  set deleteFileRequest($core.String v) {
    $_setString(20, v);
  }
  ...
  @$pb.TagNumber(35)
  set setModuleConfig($2.ModuleConfig v) {
    setField(35, v);
  }
  ...
  @$pb.TagNumber(39)
  set setFavoriteNode($core.int v) {
  ...
  @$pb.TagNumber(40)
  set removeFavoriteNode($core.int v) {
  ...
  @$pb.TagNumber(41)
  set setFixedPosition($6.Position v) {
    setField(41, v);
  }
  ...
  @$pb.TagNumber(42)
  set removeFixedPosition($core.bool v) {
    $_setBool(31, v);
  }
