...
import 'deviceonly.pb.dart' as $9;
...
class AdminMessage extends $pb.GeneratedMessage {
  factory AdminMessage({
    ...
    $0.Config? getConfigResponse,
    AdminMessage_ModuleConfigType? getModuleConfigRequest,
    $1.ModuleConfig? getModuleConfigResponse,
    ...
    $0.Config? setConfig,
    $1.ModuleConfig? setModuleConfig,
  ...
  factory AdminMessage.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);

  factory AdminMessage.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$3.Channel>(2, _omitFieldNames ? '' : 'getChannelResponse',
        subBuilder: $3.Channel.create)
    ..aOB(3, _omitFieldNames ? '' : 'getOwnerRequest')
    ..aOM<$6.User>(4, _omitFieldNames ? '' : 'getOwnerResponse',
    ...
    ..aOM<$0.Config>(6, _omitFieldNames ? '' : 'getConfigResponse',
    ...
    ..aOM<$1.ModuleConfig>(8, _omitFieldNames ? '' : 'getModuleConfigResponse',
        subBuilder: $1.ModuleConfig.create)
    ...
    ..aOM<$6.DeviceMetadata>(
        13, _omitFieldNames ? '' : 'getDeviceMetadataResponse',
        subBuilder: $6.DeviceMetadata.create)
    ...
    ..aOM<$8.DeviceConnectionStatus>(
        17, _omitFieldNames ? '' : 'getDeviceConnectionStatusResponse',
        subBuilder: $8.DeviceConnectionStatus.create)
    ...
    ..aOM<$6.User>(32, _omitFieldNames ? '' : 'setOwner',
        subBuilder: $6.User.create)
    ..aOM<$3.Channel>(33, _omitFieldNames ? '' : 'setChannel',
        subBuilder: $3.Channel.create)
    ..aOM<$0.Config>(34, _omitFieldNames ? '' : 'setConfig',
        subBuilder: $0.Config.create)
    ..aOM<$1.ModuleConfig>(35, _omitFieldNames ? '' : 'setModuleConfig',
        subBuilder: $1.ModuleConfig.create)
    ...
    ..a<$core.int>(
        99, _omitFieldNames ? '' : 'factoryReset', $pb.PbFieldType.O3)
    ..a<$core.int>(
  ...
  @$pb.TagNumber(1)
  set getChannelRequest($core.int v) {
  ...
  @$pb.TagNumber(2)
  set getChannelResponse($3.Channel v) {
    setField(2, v);
  }
  ...
  @$pb.TagNumber(3)
  set getOwnerRequest($core.bool v) {
    $_setBool(2, v);
  }
  ...
  @$pb.TagNumber(5)
  set getConfigRequest(AdminMessage_ConfigType v) {
    setField(5, v);
  }
  ...
  @$pb.TagNumber(6)
  $0.Config get getConfigResponse => $_getN(5);

  @$pb.TagNumber(6)
  set getConfigResponse($0.Config v) {
    setField(6, v);
  }
  ...
  @$pb.TagNumber(6)
  $0.Config ensureGetConfigResponse() => $_ensure(5);
  ...
  @$pb.TagNumber(7)
  set getModuleConfigRequest(AdminMessage_ModuleConfigType v) {
    setField(7, v);
  }
  ...
  ///  Send the current Config in the response to this message.
  @$pb.TagNumber(8)
  $1.ModuleConfig get getModuleConfigResponse => $_getN(7);

  @$pb.TagNumber(8)
  set getModuleConfigResponse($1.ModuleConfig v) {
    setField(8, v);
  }
  ...
  @$pb.TagNumber(8)
  $1.ModuleConfig ensureGetModuleConfigResponse() => $_ensure(7);
  ...
  @$pb.TagNumber(10)
  set getCannedMessageModuleMessagesRequest($core.bool v) {
    $_setBool(8, v);
  }
  ...
  @$pb.TagNumber(11)
  set getCannedMessageModuleMessagesResponse($core.String v) {
    $_setString(9, v);
  }
  ...
  @$pb.TagNumber(12)
  set getDeviceMetadataRequest($core.bool v) {
    $_setBool(10, v);
  }
  ...
  @$pb.TagNumber(13)
  set getDeviceMetadataResponse($6.DeviceMetadata v) {
    setField(13, v);
  }
  ...
  @$pb.TagNumber(14)
  set getRingtoneRequest($core.bool v) {
    $_setBool(12, v);
  }
  ...
  @$pb.TagNumber(15)
  set getRingtoneResponse($core.String v) {
    $_setString(13, v);
  }
  ...
  @$pb.TagNumber(16)
  set getDeviceConnectionStatusRequest($core.bool v) {
    $_setBool(14, v);
  }
  ...
  @$pb.TagNumber(17)
  set getDeviceConnectionStatusResponse($8.DeviceConnectionStatus v) {
    setField(17, v);
  }
  ...
  @$pb.TagNumber(17)
  $8.DeviceConnectionStatus ensureGetDeviceConnectionStatusResponse() =>
      $_ensure(15);
  ...
  @$pb.TagNumber(18)
  set setHamMode(HamParameters v) {
    setField(18, v);
  }
  ...
  @$pb.TagNumber(19)
  set getNodeRemoteHardwarePinsRequest($core.bool v) {
    $_setBool(17, v);
  }
  ...
  @$pb.TagNumber(20)
  set getNodeRemoteHardwarePinsResponse(NodeRemoteHardwarePinsResponse v) {
    setField(20, v);
  }
  ...
  @$pb.TagNumber(21)
  set enterDfuModeRequest($core.bool v) {
    $_setBool(19, v);
  }
  ...
  @$pb.TagNumber(32)
  $6.User get setOwner => $_getN(20);

  @$pb.TagNumber(32)
  set setOwner($6.User v) {
    setField(32, v);
  }

  @$pb.TagNumber(32)
  $core.bool hasSetOwner() => $_has(20);

  @$pb.TagNumber(32)
  void clearSetOwner() => clearField(32);

  @$pb.TagNumber(32)
  $6.User ensureSetOwner() => $_ensure(20);
  ...
  @$pb.TagNumber(33)
  $3.Channel get setChannel => $_getN(21);

  @$pb.TagNumber(33)
  set setChannel($3.Channel v) {
    setField(33, v);
  }

  @$pb.TagNumber(33)
  $core.bool hasSetChannel() => $_has(21);

  @$pb.TagNumber(33)
  void clearSetChannel() => clearField(33);

  @$pb.TagNumber(33)
  $3.Channel ensureSetChannel() => $_ensure(21);

  ///
  ///  Set the current Config
  @$pb.TagNumber(34)
  $0.Config get setConfig => $_getN(22);

  @$pb.TagNumber(34)
  set setConfig($0.Config v) {
    setField(34, v);
  }

  @$pb.TagNumber(34)
  $core.bool hasSetConfig() => $_has(22);

  @$pb.TagNumber(34)
  void clearSetConfig() => clearField(34);

  @$pb.TagNumber(34)
  $0.Config ensureSetConfig() => $_ensure(22);

  ///
  ///  Set the current Config
  @$pb.TagNumber(35)
  $1.ModuleConfig get setModuleConfig => $_getN(23);

  @$pb.TagNumber(35)
  set setModuleConfig($1.ModuleConfig v) {
    setField(35, v);
  }

  @$pb.TagNumber(35)
  $core.bool hasSetModuleConfig() => $_has(23);

  @$pb.TagNumber(35)
  void clearSetModuleConfig() => clearField(35);

  @$pb.TagNumber(35)
  $1.ModuleConfig ensureSetModuleConfig() => $_ensure(23);

  ///
  ///  Set the Canned Message Module messages text.
  @$pb.TagNumber(36)
  $core.String get setCannedMessageModuleMessages => $_getSZ(24);

  @$pb.TagNumber(36)
  set setCannedMessageModuleMessages($core.String v) {
    $_setString(24, v);
  }

  @$pb.TagNumber(36)
  $core.bool hasSetCannedMessageModuleMessages() => $_has(24);
  ...
  @$pb.TagNumber(37)
  $core.String get setRingtoneMessage => $_getSZ(25);

  @$pb.TagNumber(37)
  set setRingtoneMessage($core.String v) {
    $_setString(25, v);
  }

  @$pb.TagNumber(37)
  $core.bool hasSetRingtoneMessage() => $_has(25);
  ...
  @$pb.TagNumber(38)
  $core.int get removeByNodenum => $_getIZ(26);

  @$pb.TagNumber(38)
  set removeByNodenum($core.int v) {
    $_setUnsignedInt32(26, v);
  }

  @$pb.TagNumber(38)
  $core.bool hasRemoveByNodenum() => $_has(26);
  ...
  @$pb.TagNumber(64)
  $core.bool get beginEditSettings => $_getBF(27);

  @$pb.TagNumber(64)
  set beginEditSettings($core.bool v) {
    $_setBool(27, v);
  }

  @$pb.TagNumber(64)
  $core.bool hasBeginEditSettings() => $_has(27);
  ...
  @$pb.TagNumber(65)
  $core.bool get commitEditSettings => $_getBF(28);

  @$pb.TagNumber(65)
  set commitEditSettings($core.bool v) {
    $_setBool(28, v);
  }

  @$pb.TagNumber(65)
  $core.bool hasCommitEditSettings() => $_has(28);
  ...
  @$pb.TagNumber(95)
  $core.int get rebootOtaSeconds => $_getIZ(29);

  @$pb.TagNumber(95)
  set rebootOtaSeconds($core.int v) {
    $_setSignedInt32(29, v);
  }

  @$pb.TagNumber(95)
  $core.bool hasRebootOtaSeconds() => $_has(29);
  ...
  @$pb.TagNumber(96)
  $core.bool get exitSimulator => $_getBF(30);

  @$pb.TagNumber(96)
  set exitSimulator($core.bool v) {
    $_setBool(30, v);
  }

  @$pb.TagNumber(96)
  $core.bool hasExitSimulator() => $_has(30);
  ...
  @$pb.TagNumber(97)
  $core.int get rebootSeconds => $_getIZ(31);

  @$pb.TagNumber(97)
  set rebootSeconds($core.int v) {
    $_setSignedInt32(31, v);
  }

  @$pb.TagNumber(97)
  $core.bool hasRebootSeconds() => $_has(31);
  ...
  @$pb.TagNumber(98)
  $core.int get shutdownSeconds => $_getIZ(32);

  @$pb.TagNumber(98)
  set shutdownSeconds($core.int v) {
    $_setSignedInt32(32, v);
  }

  @$pb.TagNumber(98)
  $core.bool hasShutdownSeconds() => $_has(32);
  ...
  @$pb.TagNumber(99)
  $core.int get factoryReset => $_getIZ(33);

  @$pb.TagNumber(99)
  set factoryReset($core.int v) {
    $_setSignedInt32(33, v);
  }

  @$pb.TagNumber(99)
  $core.bool hasFactoryReset() => $_has(33);
  ...
  @$pb.TagNumber(100)
  $core.int get nodedbReset => $_getIZ(34);

  @$pb.TagNumber(100)
  set nodedbReset($core.int v) {
    $_setSignedInt32(34, v);
  }

  @$pb.TagNumber(100)
  $core.bool hasNodedbReset() => $_has(34);
...
class HamParameters extends $pb.GeneratedMessage {
  ...
  factory HamParameters.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);

  factory HamParameters.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
...
class NodeRemoteHardwarePinsResponse extends $pb.GeneratedMessage {
  factory NodeRemoteHardwarePinsResponse({
    $core.Iterable<$9.NodeRemoteHardwarePin>? nodeRemoteHardwarePins,
  }) {
    final $result = create();
  ...
  factory NodeRemoteHardwarePinsResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);

  factory NodeRemoteHardwarePinsResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'meshtastic'),
      createEmptyInstance: create)
    ..pc<$9.NodeRemoteHardwarePin>(
        1, _omitFieldNames ? '' : 'nodeRemoteHardwarePins', $pb.PbFieldType.PM,
        subBuilder: $9.NodeRemoteHardwarePin.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $core.List<$9.NodeRemoteHardwarePin> get nodeRemoteHardwarePins =>
      $_getList(0);
}
